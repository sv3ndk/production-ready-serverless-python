...
@given("I am on the main page", target_fixture="index_response")
def get_index_page(app_restaurant_url: str, cognito_user_pool_id: str, cognito_web_user_pool_client_id: str) -> dict:
